import { View, Text, SafeAreaView, StatusBar, Dimensions, StyleSheet, TextInput, TouchableOpacity, Image, Alert } from 'react-native'
            ...
            <LinearGradient
                ...
                <View style={styles.maincontainer}>
                    ...
                    <View style={styles.otpContainer}>
                        ...
                        <OTPTextView inputCount={4} tintColor={'#1C1F22'} handleTextChange={e => setOtp(e)} />
                    </View>


                    <View style={styles.resendOtp}>
                        <Text style={styles.sendtxt}>
                            Resend in <Text style={styles.txt}>00:
                                {/* {counter} */}
                            </Text>
                        </Text>
                    </View>
